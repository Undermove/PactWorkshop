...
namespace SushiTrackerApi.ProducerTests.Middleware
{
    public class SushiTrakerApiStateMiddleware
    {
        private const string ConsumerName = "Consumer";
        private readonly RequestDelegate _next;
        private readonly IDictionary<string, Action> _providerStates;

        public SushiTrakerApiStateMiddleware(RequestDelegate next)
        {
            _next = next;
        ...
        private void HandleProviderStatesRequest(HttpContext context)
        {
                ...
                context.Request.Body != null)
            {
                ...
                var providerState = JsonConvert.DeserializeObject<SushiTrackerApiState>(jsonRequestBody);
